...
export type RepertoireScoreBlockContract = BlockContract;
export type RepertoireScoreBlockOutputs  = BlockOutputs;
export type RepertoireScoreBlockData     = BlockData;
export const RepertoireScoreBlockPointer = BlockPointer;
